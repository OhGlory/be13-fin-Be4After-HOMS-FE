    ...
    <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative bg-white shadow-lg w-full max-w-5xl text-center z-10 pb-10">
            ...
            <div class="grid grid-cols-3 mx-10">
                ...
                <!-- 국가 -->
                <label
                    class="flex pl-3 h-full items-center bg-gray-200 border border-gray-400 font-semibold self-center">국가</label>
                ...
                <label
                    class=" flex items-center pl-3 h-full bg-gray-200 border border-gray-400 font-semibold self-center">파트너사명</label>
                <div class="col-span-2 p-2 border border-gray-400">
                ...
                <!-- 사업자 등록번호 -->
                <label
                    class=" flex items-center pl-3 h-full bg-gray-200 border border-gray-400 font-semibold self-center">사업자
                    등록번호</label>
                <div class="col-span-2 p-2 border border-gray-400">
                    <input v-model="form.companyNumber" type="text" placeholder="000-00-00000"
                        class="flex w-1/3 border border-gray-400 text-md">
                </div>

                <!-- 대표자명 -->
                <label
                    class=" flex items-center pl-3 h-full bg-gray-200 border border-gray-400 font-semibold self-center">대표자명</label>
                <div class="col-span-2 p-2 border border-gray-400">
                ...
                <!-- 대표전화번호 -->
                <label
                    class=" flex items-center pl-3 h-full bg-gray-200 border border-gray-400 font-semibold self-center">대표전화번호</label>
                <div class="col-span-2 p-2 border border-gray-400">
                ...
                <label
                    class=" flex items-center pl-3 h-full bg-gray-200 border border-gray-400 font-semibold self-center">대표모바일번호</label>
                <div class="col-span-2 p-2 border border-gray-400">
                ...
                <!-- 담당자명 -->
                <label
                    class=" flex items-center pl-3 h-full bg-gray-200 border border-gray-400 font-semibold self-center">담당자명</label>
                <div class="col-span-2 p-2 border border-gray-400">
                ...
                <!-- 담당자Email -->
                <label
                    class=" flex items-center pl-3 h-full bg-gray-200 border border-gray-400 font-semibold self-center">담당자
                    E-mail</label>
                <div class="col-span-2 p-2 border border-gray-400">
            ...
            <div class="flex gap-10 justify-center mt-5">
                <button @click="showSuccess = true"
                    class="px-6 py-3 w-1/6 bg-orange-600 text-white font-bold  hover:bg-orange-700 transition">
                    저장
                </button>

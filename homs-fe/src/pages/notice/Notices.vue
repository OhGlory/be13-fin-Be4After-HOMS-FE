                    ...
                    <div
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody class="bg-white">
                                <tr TeamListItem v-for="team in teams" :key="team.no" :team="team">
                                    ...
                                    <td
                                        ...
                                        <div class="flex justify-around">
                                            <span class="text-yellow-500 flex justify-center">
                                                <a href="#" class="mx-2 px-2 rounded-md"><svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        class="h-5 w-5 text-green-700" viewBox="0 0 20 20"
                                                        fill="currentColor">
                                                        <path
                                                ...
                                                <button class="mx-2 px-2 rounded-md" @click="deleteTeam(team.no)">

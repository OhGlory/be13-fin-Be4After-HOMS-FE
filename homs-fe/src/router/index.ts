                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            meta: {
                                requiresAuth: true,
                                role: "ROLE_ADMIN",
                                breadcrumb: (route: {params: {id: any}}) => `계정 상세 (${route.params.id})`,
                            },
                        },
                    ],
                },
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            meta: {
                                requiresAuth: true,
                                role: "ROLE_ADMIN",
                                breadcrumb: (route: {params: {id: any}}) => `거래처 상세 (${route.params.id})`,
                            },
                        },
                    ],
                },
                ...
                // --- 사용자 공지사항 그룹 ---
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            meta: {
                                requiresAuth: false,
                                breadcrumb: (route: {params: {id: any}}) => `상세 (${route.params.id})`,
                            },
                        },
                    ],
                },
                // --- 사용자 클레임 관리 그룹 ---
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            meta: {
                                requiresAuth: false,
                                breadcrumb: (route: {params: {orderId: any}}) => `클레임 상세 (${route.params.orderId})`,
                            },
                        },
                    ],
                },
